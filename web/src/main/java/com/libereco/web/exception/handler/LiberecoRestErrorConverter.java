 ...
 * a {@link LiberecoRestError} object into another object that is potentially better suited for HTTP response rendering by an
 ...
 *
 */
public interface LiberecoRestErrorConverter<T> extends Converter<LiberecoRestError, T> {
     ...
     */
    T convert(LiberecoRestError re);
}
