...
public class ShippingInformationController {
    ...
    public String create(@Valid ShippingInformation shippingInformation, BindingResult bindingResult, Model uiModel,
        ...
        uiModel.asMap().clear();
        shippingInformationService.saveShippingInformation(shippingInformation);
    ...
    public String createForm(Model uiModel) {
        populateEditForm(uiModel, new ShippingInformation());
        return "liberecolisting/shippinginformations/create";
    }

    @RequestMapping(value = "/{id}", produces = "text/html")
    public String show(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("shippingInformation", shippingInformationService.findShippingInformation(id));
    ...
    public String update(@Valid ShippingInformation shippingInformation, BindingResult bindingResult, Model uiModel,
            HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, shippingInformation);
        ...
        uiModel.asMap().clear();
        shippingInformationService.updateShippingInformation(shippingInformation);
        return "redirect:/liberecolisting/shippinginformations/" + encodeUrlPathSegment(shippingInformation.getId().toString(), httpServletRequest);
    }
    
    @RequestMapping(value = "/{id}", params = "form", produces = "text/html")
    public String updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, shippingInformationService.findShippingInformation(id));
        return "liberecolisting/shippinginformations/update";
    }

    void populateEditForm(Model uiModel, ShippingInformation shippingInformation) {
