...
public class LiberecoUserIntegrationTest {
    ...
    public void testFindAllLiberecoUsers() {
        ...
        long count = liberecoUserService.countAllLiberecoUsers();
        Assert.assertTrue(
                "Too expensive to perform a find all test for 'LiberecoUser', as there are "
                        + count
    ...
    public void testFlush() {
        ...
        Assert.assertTrue("Version for 'LiberecoUser' failed to increment on flush directive",
    ...
    public void testUpdateLiberecoUserUpdate() {
        ...
        Assert.assertTrue("Version for 'LiberecoUser' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
